...
export default config({
  storage: {
    kind: 'github',
    repo: 'jesusdavidweb/eleahora-demo',
  },
  ...
  singletons: {
    ...
    siteConfig: singleton({
      ...
      schema: {
        ...
        siteDescription: fields.text({
          ...
          multiline: true,
          defaultValue: 'Eleahora: Terapia Transpersonal, Meditación y Mindfulness con Maria Eleonora Corallo.',
        }),
        ...
        facebookUrl: fields.url({
          label: 'URL Facebook',
          defaultValue: 'https://www.facebook.com/profile.php?id=100063992806553',
        }),
    ...
    homePage: singleton({
      ...
      schema: {
        ...
        mindfulnessLead: fields.text({
          ...
          multiline: true,
          defaultValue: 'La meditación es una herramienta de neuroregulación. El mindfulness es una práctica que entrena la mente para volver al momento presente.',
        }),
        mindfulnessBody: fields.text({
          label: 'Mindfulness — Párrafo descriptivo',
          multiline: true,
          defaultValue: 'A través de la respiración, la atención plena y la consciencia corporal, el sistema nervioso aprende a salir del estado de alerta constante.',
        }),
    ...
    aboutPage: singleton({
      ...
      schema: {
        heroLabel: fields.text({ label: 'Etiqueta superior', defaultValue: 'Sobre mí' }),
        heroTitle: fields.text({ label: 'Título principal (H1)', defaultValue: 'Maria Eleonora Corallo' }),
        heroSubtitle: fields.text({ label: 'Subtítulo / tagline', multiline: true, defaultValue: 'Terapeuta Transpersonal · Guía de Meditación · PNL' }),
        profileImage: fields.image({ label: 'Foto de perfil principal', directory: 'public/images', publicPath: '/images/' }),
        bioIntro: fields.text({ label: 'Introducción biográfica', multiline: true }),
        bioBody: fields.document({ label: 'Texto biográfico completo', formatting: true }),
        manifestoTitle: fields.text({ label: 'Manifiesto — Título', defaultValue: 'Mi manifiesto' }),
        manifestoText: fields.text({ label: 'Manifiesto — Texto', multiline: true }),
        galleryImage1: fields.image({ label: 'Galería — Imagen 1', directory: 'public/images', publicPath: '/images/' }),
        galleryImage2: fields.image({ label: 'Galería — Imagen 2', directory: 'public/images', publicPath: '/images/' }),
        ctaTitle: fields.text({ label: 'CTA — Título', defaultValue: '¿Lista para comenzar?' }),
        ctaBody: fields.text({ label: 'CTA — Cuerpo', multiline: true, defaultValue: 'Si algo de lo que has leído resuena contigo, me encantaría acompañarte en tu proceso.' }),
        ctaButtonText: fields.text({ label: 'CTA — Texto del botón', defaultValue: 'Agenda una sesión' }),
      },
    }),
    ...
    sessionesPage: singleton({
      ...
      schema: {
        heroLabel: fields.text({ label: 'Etiqueta superior', defaultValue: 'Sesiones' }),
        heroTitle: fields.text({ label: 'Título (H1)', defaultValue: 'Estoy aquí para ti.' }),
        heroSubtitle: fields.text({ label: 'Subtítulo', multiline: true, defaultValue: 'Cada sesión está diseñada como un espacio seguro para que puedas volver a ti.' }),
        heroImage: fields.image({ label: 'Imagen de cabecera', directory: 'public/images', publicPath: '/images/' }),
        ctaTitle: fields.text({ label: 'CTA final — Título', defaultValue: '¿No sabes por dónde empezar?' }),
        ctaBody: fields.text({ label: 'CTA final — Texto', multiline: true, defaultValue: 'Escríbeme y hablamos. Juntas encontramos el punto de partida.' }),
      },
    }),
    ...
    workshopPage: singleton({
      ...
      schema: {
        heroLabel: fields.text({ label: 'Etiqueta superior', defaultValue: 'Workshop para empresas' }),
        heroTitle: fields.text({ label: 'Título principal (H1)', defaultValue: 'Pienso, luego medito.' }),
        heroSubtitle: fields.text({ label: 'Subtítulo', multiline: true, defaultValue: 'Una experiencia de mindfulness y meditación diseñada para equipos y organizaciones.' }),
        heroImage: fields.image({ label: 'Imagen de cabecera', directory: 'public/images', publicPath: '/images/' }),
        introTitle: fields.text({ label: 'Sección intro — Título' }),
        introBody: fields.document({ label: 'Sección intro — Cuerpo', formatting: true }),
        benefitsTitle: fields.text({ label: 'Beneficios — Título', defaultValue: '¿Qué se llevan los equipos?' }),
        ...
        ctaButtonText: fields.text({ label: 'CTA — Texto del botón', defaultValue: 'Solicitar información' }),
      },
    }),
    ...
    contactoPage: singleton({
      ...
      schema: {
        heroTitle: fields.text({ label: 'Título principal', defaultValue: 'Hablemos.' }),
        heroSubtitle: fields.text({ label: 'Subtítulo', multiline: true, defaultValue: 'Estoy aquí para escucharte y acompañarte en el primer paso.' }),
        processTitle: fields.text({ label: 'Panel de proceso — Título', defaultValue: '¿Cómo funciona?' }),
  ...
  collections: {
    ...
    sesiones: collection({
      ...
      schema: {
        ...
        featured: fields.checkbox({ label: '¿Destacar en página de inicio?', defaultValue: false }),
        tagline: fields.text({ label: 'Tagline corto', description: 'Una frase breve que aparece sobre el título' }),
        description: fields.document({ label: 'Descripción completa', formatting: true }),
        ...
        price: fields.text({ label: 'Precio', description: 'Ej: 75€ / consultar' }),
        image: fields.image({ label: 'Imagen de la sesión', directory: 'public/images/sesiones', publicPath: '/images/sesiones/' }),
        bookingUrl: fields.url({ label: 'URL de reserva directa', defaultValue: 'https://cal.eu/eleahora/sesiones' }),
    ...
    testimonios: collection({
      ...
      schema: {
        ...
        service: fields.text({ label: 'Servicio recibido', description: 'Ej: Sesión de Terapia con PNL' }),
        photo: fields.image({ label: 'Foto (opcional)', directory: 'public/images/testimonios', publicPath: '/images/testimonios/' }),
        featured: fields.checkbox({ label: '¿Mostrar en página de inicio?', defaultValue: true }),
        order: fields.integer({ label: 'Orden de aparición', defaultValue: 1 }),
      },
    }),
